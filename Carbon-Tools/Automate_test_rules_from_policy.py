...
def create_query(rule):
    ...
    query_patterns = {
        ...
        "CODE_INJECTION": f"(process_effective_reputation:SUSPECT_MALWARE AND (ttp:INJECT_CODE OR ttp:HAS_INJECTED_CODE OR ttp:COMPROMISED_PROCESS OR ttp:PROCESS_IMAGE_REPLACED OR ttp:MODIFY_PROCESS OR ttp:MODIFY_PROCESS_EXECUTION OR ttp:HOLLOW_PROCESS))",
